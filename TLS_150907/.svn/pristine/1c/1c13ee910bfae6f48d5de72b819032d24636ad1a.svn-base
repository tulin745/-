...
{
    if (!_iconImgView) {
        UIImage *iconImage = [UIImage imageNamed:@"solanIcon"];
        _iconImgView = [[UIImageView alloc] initWithFrame:CGRectMake((self.width-iconImage.size.width)*0.5, 0, iconImage.size.width, iconImage.size.height)];
        [_iconImgView setImage:iconImage];
